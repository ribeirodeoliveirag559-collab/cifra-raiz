...
const faqs = [
  ...
  },
  {
    ...
    a: "É um pagamento único de R$ 16,90 e o acesso é vitalício. Você paga uma vez e acessa para sempre, sem mensalidade, sem renovação automática.",
  },
  {
            ...
            {[
              {
                ...
                desc: "Pagamento único de R$ 16,90. Acesso imediato e vitalício — sem mensalidade, sem burocracia.",
            ...
            <div className="bg-[#4A2810] border-2 border-[#D4900A] rounded-3xl p-8 relative overflow-hidden shadow-2xl">
              ...
              <div className="mb-6 relative">
                ...
                <div className="flex items-end gap-2">
                  <p className="font-display text-5xl font-black text-white">R$ 16,90</p>
                </div>
      ...
      <section className="py-24 px-4 bg-[#4A2810] text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-[#B5865A] text-lg mb-4 max-w-xl mx-auto">
            ...
            Um pagamento único de R$ 16,90 — acesso para sempre.
          </p>
